...
public class RecipeActivity extends BaseActivity {
    ...
    public void subscribeObservers(final String recipeId) {
                ...
                if(recipeResource != null) {
                    if(recipeResource.data != null) {
                        switch (recipeResource.status) {
                            ...
                            case ERROR:{
                                Log.e(TAG, "onChanged: status ERROR "+recipeResource.message);
                                showParent();
                            ...
                            case SUCCESS:{
                                Log.i(TAG, "Cache has been refreshed "+recipeResource.data.getTitle());
                                showParent();
                                showProgressBar(false);
                                setRecipeProperties(recipeResource.data);
                                break;
