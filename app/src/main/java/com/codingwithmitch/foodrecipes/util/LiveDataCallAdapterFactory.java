...
public class LiveDataCallAdapterFactory extends CallAdapter.Factory {
     ...
     *
     * We feed this object into ServiceGenerator to allow for Retrofit calls to convert into LiveData. No longer
     * need AppExecutors or Runnables!
     *
     * @param returnType
     * @param annotations
     * @param retrofit
    ...
    public CallAdapter<?, ?> get(Type returnType, Annotation[] annotations, Retrofit retrofit) {
        ...
        // Check #1
        // Make sure the CallAdapter is returning a type of LiveData. If not return NULL
        if(CallAdapter.Factory.getRawType(returnType) != LiveData.class){
            return null;
        }

        // Check #2
        // Type that LiveData is wrapping. Parameterized type means the class is a wrapper around some other type
